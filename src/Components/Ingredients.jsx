...
return (
  <div className="flex flex-col justify-center items-center mb-10 mt-6">
    ...
    <div className="flex mt-4 gap-6">
      <div
        className="inline-flex p-2 items-center gap-2 w-[137px] h-[32px]
      ...
      <div
        className="inline-flex p-2 items-center gap-2 w-[137px] h-[32px]
             rounded-md border border-gray-300 bg-gray-50"
      >
        <img src={servingIcon} alt="reset icon" className="w-4 h-4" />
        <p className="text-[#171717] font-manrope text-xs font-semibold leading-[1.2]">
          1 SERVING
        </p>
      </div>
    ...
    <div className="flex w-[390px] items-center mt-6 h-[62px] border-b-2 p-4 border-b-gray-100 gap-6">
      <div
        className="flex p-1 md:p-2 justify-center items-center w-[71px] h-[26px] gap-2 rounded-xl 
      ...
      <div
        className="flex p-1 md:p-2 justify-center items-center w-[110px] h-[26px] gap-2 rounded-xl 
      ...
      <div
        className="flex p-1 md:p-2 justify-center items-center w-[130px] h-[26px] gap-2 rounded-xl 
             bg-[#F4F4F4]"
      >
        <p className="text-center font-manrope text-xs font-semibold leading-[1.5]">
          How to prepare it
